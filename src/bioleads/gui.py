...
class BioleadsGUI:
    ...
    def _build_inputs(self, page) -> None:
        ...
        self._add_tooltip(
            ...
            "PMID list.\n\n"
            "The first run on a corpus fetches from NIH iCite; after that the "
            "records are cached for a month under ~/.cache/bioleads, so "
            "repeats cost nothing and work with no network. Untick it only for "
            "a first look at a large corpus you would rather not wait on.\n\n"
